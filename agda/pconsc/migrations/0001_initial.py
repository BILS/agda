...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PredictallJob'
        db.create_table('pconsc_predictalljob', (
            ('job_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['agda.Job'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('pconsc', ['PredictallJob'])

    def backwards(self, orm):
        # Deleting model 'PredictallJob'
        db.delete_table('pconsc_predictalljob')
    ...
    models = {
        ...
        'pconsc.predictalljob': {
            'Meta': {'object_name': 'PredictallJob', '_ormbases': ['agda.Job']},
            'job_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['agda.Job']", 'unique': 'True', 'primary_key': 'True'})
        }
    }
