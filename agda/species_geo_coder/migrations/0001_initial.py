...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SpeciesGeoCoderJob'
        db.create_table(u'species_geo_coder_speciesgeocoderjob', (
            (u'job_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['jobs.Job'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'species_geo_coder', ['SpeciesGeoCoderJob'])


    def backwards(self, orm):
        # Deleting model 'SpeciesGeoCoderJob'
        db.delete_table(u'species_geo_coder_speciesgeocoderjob')
    ...
    models = {
        ...
        u'species_geo_coder.speciesgeocoderjob': {
            'Meta': {'object_name': 'SpeciesGeoCoderJob', '_ormbases': [u'jobs.Job']},
            u'job_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['jobs.Job']", 'unique': 'True', 'primary_key': 'True'})
        }
    }

    complete_apps = ['species_geo_coder']